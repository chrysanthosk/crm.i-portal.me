                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="datetime-local" name="registration_date" class="form-control"
                               value="{{ old('registration_date', optional($client->registration_date)->format('Y-m-d\TH:i')) }}">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="date" name="dob" class="form-control"
                               value="{{ old('dob', optional($client->dob)->format('Y-m-d')) }}" required>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="gender" class="form-control" required>
                            ...
                            <option value="{{ $g }}" @selected(old('gender', $client->gender) === $g)>{{ $g }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="mobile" class="form-control"
                               value="{{ old('mobile', $client->mobile) }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea name="comments" class="form-control" rows="4">{{ old('comments', $client->comments) }}</textarea>
